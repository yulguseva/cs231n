...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        #(4)
        scores, cache_taffine = temporal_affine_forward(h, W_vocab, b_vocab)
        #(5)
        ...
        #(5) dx
        #(4)
        dh, dW_vocab, db_vocab = temporal_affine_backward(dx, cache_taffine)
        #(3)
        if self.cell_type == 'rnn':
        ...
        grads = {'W_proj':dW_proj, 'b_proj':db_proj, 'W_embed':dW_embed, 
                 'Wx':dWx, 'Wh':dWh, 'b':db, 'W_vocab':dW_vocab, 'b_vocab':db_vocab}
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
